...
<@pp.changeOutputFile name="/org/apache/drill/exec/expr/fn/impl/gcast/SafeCast${type.from}${type.to}.java" />
...
@FunctionTemplate(name = "safe_cast${type.to?upper_case}",
    scope = FunctionTemplate.FunctionScope.SIMPLE,
    nulls = NullHandling.NULL_IF_NULL)
public class SafeCast${type.from}${type.to} implements DrillSimpleFunc {
