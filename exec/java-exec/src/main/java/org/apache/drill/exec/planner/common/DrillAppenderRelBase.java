...
public abstract class DrillAppenderRelBase extends SingleRel implements DrillRelNode {
  ...
  public DrillAppenderRelBase(Convention convention, RelOptCluster cluster, RelTraitSet traitSet, RelNode input) {
