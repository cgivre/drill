...
- [ProspectorReports.md](ProspectorReports.md) — design for preserving a Prospector analysis: a generated markdown report saved into a project wiki under a Reports folder, and PDF download of any wiki page. Design agreed, not yet implemented.
